...
Para mais informações sobre a arquitetura e estrutura do projeto, consulte os seguintes arquivos:

- [ARCHITECTURE.md](ARCHITECTURE.md): Detalhes sobre as decisões arquiteturais do sistema.
- [PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md): Estrutura detalhada do projeto e organização dos diretórios.
